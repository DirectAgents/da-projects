    ...
    public static class AmazonApiHelper
    {
        ...
        private static readonly Dictionary<AttributedMetricType, Dictionary<AttributedMetricDaysInterval, string>> AttributedMetrics =
            new Dictionary<AttributedMetricType, Dictionary<AttributedMetricDaysInterval, string>>
            {
                ...
                {
                    AttributedMetricType.attributedConversionsSameSKU, new Dictionary<AttributedMetricDaysInterval, string>
                    {
                ...
                {
                    AttributedMetricType.attributedUnitsOrdered, new Dictionary<AttributedMetricDaysInterval, string>
                    {
                ...
                {
                    AttributedMetricType.attributedSalesSameSKU, new Dictionary<AttributedMetricDaysInterval, string>
                    {
        ...
        {
            return $"v2/{dataType}/{dataId}";
        }
        
        public static AmazonApiReportParams CreateReportParams(EntitesType entitiesType, CampaignType campaignType, DateTime date, bool includeCampaignName)
        {
        ...
        private static string GetReportMetrics(EntitesType entitiesType, CampaignType campaignType, bool includeCampaignName)
        {
