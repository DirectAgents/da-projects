...
using Adform.Outdated.Entities.ReportEntities.ReportParameters;
using Adform.Outdated.Helpers;
using Adform.Entities.ResponseEntities;
using Polly;
using RestSharp;
using RestSharp.Authenticators;
using RestSharp.Deserializers;
using ReportData = Adform.Outdated.Entities.ReportEntities.ReportData;
using ReportSettings = Adform.Outdated.Entities.ReportSettings;

namespace Adform.Outdated.Utilities
{
    /// <summary>
