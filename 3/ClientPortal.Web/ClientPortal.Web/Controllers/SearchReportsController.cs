...
namespace ClientPortal.Web.Controllers
{
    ...
    public class SearchReportsController : CPController
    {
        ...
        public JsonResult WeekSumData(KendoGridRequest request, int numweeks = 8)
        {
            ...
            var weekStats = cpRepo.GetWeekStats(userInfo.AdvertiserId, null, numweeks, userInfo.WeekStartDay, userInfo.UseAnalytics, !userInfo.UseYesterdayAsLatest);
        ...
        public JsonResult ChannelPerfData(KendoGridRequest request) //, string startdate, string enddate)
        {
            ...
            var channelStats = cpRepo.GetChannelStats(userInfo.AdvertiserId, userInfo.WeekStartDay, userInfo.UseAnalytics, !userInfo.UseYesterdayAsLatest);
        ...
        public FileResult ChannelPerfExport()
        {
            ...
            var stats = cpRepo.GetChannelStats(userInfo.AdvertiserId, userInfo.WeekStartDay, userInfo.UseAnalytics, !userInfo.UseYesterdayAsLatest);
        ...
        public JsonResult CampaignPerfWeeklyData(string startdate, string enddate)
        {
            ...
            var rows = cpRepo.GetCampaignWeekStats2(userInfo.AdvertiserId, start.Value, end.Value, userInfo.WeekStartDay, userInfo.UseAnalytics);
