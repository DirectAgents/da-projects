...
namespace CakeExtracter.Common
{
    public static class CopyPropertiesUtility
    {
        public static void Copy(object source, object target)
        {
            ...
            var items = source.EnumerateProperties().Join(target.EnumerateProperties(),
                                                          c => c.Name, c => c.Name,
            ...
            items[true].ToList().ForEach(c => c.P.SetValue(target, c.V));
            ...
            items[false].ToList().ForEach(c =>
                {
                    ...
                    // Create new instance if target property has null value
                    if (v == null)
                    {
