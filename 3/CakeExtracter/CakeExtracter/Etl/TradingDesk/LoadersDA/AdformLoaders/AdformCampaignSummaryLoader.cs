...
namespace CakeExtracter.Etl.TradingDesk.LoadersDA.AdformLoaders
{
    ...
    /// uses AdformStrategyWithoutEidStorage instead of the StrategyWithEidStorage, because Adform entities do not have portal IDs.
    /// </summary>
    internal class AdformCampaignSummaryLoader : TDStrategySummaryLoader
    {
        public AdformCampaignSummaryLoader(int accountId = -1)
            : base(accountId, StorageCollection.AdformStrategyWithoutEidStorage)
        {
