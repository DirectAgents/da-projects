...
{
    /// <summary>
    /// Extractor of daily data based on database strategy data. 
    /// </summary>
    /// <seealso cref="CakeExtracter.Etl.Extracter{DirectAgents.Domain.Entities.CPProg.DailySummary}" />
    public class DatabaseStrategyToDailySummaryExtractor : Extracter<DailySummary>
    {
        protected readonly DateRange dateRange;
        protected readonly int accountId;

        /// <summary>
        /// Initializes a new instance of the <see cref="DatabaseStrategyToDailySummaryExtracter"/> class.
        /// </summary>
        /// <param name="dateRange">The date range.</param>
        /// <param name="accountId">The account identifier.</param>
        public DatabaseStrategyToDailySummaryExtractor(DateRange dateRange, int accountId)
        {
        ...
        private IEnumerable<DailySummary> GetDailySummaryDataFromDataBase()
        {
        ...
        private void SetStatsFromDb(DailySummary daySummary, DateTime date, IEnumerable<StrategySummary> summariesFromDb)
        {
