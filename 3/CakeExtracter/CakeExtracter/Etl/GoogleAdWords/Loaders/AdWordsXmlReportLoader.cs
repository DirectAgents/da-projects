...
{
    public class AdWordsXmlReportLoader : Loader<Dictionary<string, string>>
    {
        protected override int LoadItems(List<Dictionary<string, string>> items)
        {
            ...
            // Add new Advertisers and SearchCampaigns if needed
            using (var db = new ClientPortalContext())
            {
                //Logger.Info("Adding new Advertisers..");
                ...
                //Logger.Info("Adding new SearchCampaigns..");
