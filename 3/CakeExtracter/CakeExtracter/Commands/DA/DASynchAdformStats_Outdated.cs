...
namespace CakeExtracter.Commands
{
    ...
    public class DASynchAdformStats_Outdated : ConsoleCommand
    {
        ...
        public static int RunStatic(int? accountId = null, DateTime? startDate = null, DateTime? endDate = null, string statsType = null)
        {
            ...
            var cmd = new DASynchAdformStats_Outdated
            {
                AccountId = accountId,
                StartDate = startDate,
                EndDate = endDate,
        ...
        public DASynchAdformStats_Outdated()
        {
            IsCommand("DASynchAdformStats_Outdated", "Synch Adform Stats (old tables)");
