...
namespace DirectAgents.Domain.Abstract
{
    public interface IMainRepository : IDisposable
    {
        ...
        CakeGauge GetGaugeForAllAdvertisers(DateTime? startDateForStats = null, DateTime? endDateForStats = null);
        IQueryable<CakeGauge> GetGaugesByAdvertiser(bool includeThoseWithNoStats = false, DateTime? startDateForStats = null, DateTime? endDateForStats = null);
    }
}
