...
namespace EomApp1.Screens.AutoSynch
{
    ...
    public class Model : IModel
    {
        ...
        DADatabaseEntities1 DB() { return new DADatabaseEntities1(string.Format(@"metadata=res://*/Screens.AutoSynch.Model1.csdl|res://*/Screens.AutoSynch.Model1.ssdl|res://*/Screens.AutoSynch.Model1.msl;provider=System.Data.SqlClient; provider connection string=""{0}""", cs)); }
        #endregion
    }
}
