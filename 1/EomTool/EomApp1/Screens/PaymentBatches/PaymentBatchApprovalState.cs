...
namespace EomApp1.Screens.PaymentBatches
{
    ...
    public partial class PaymentBatchApprovalState
    {
        public PaymentBatchApprovalState()
        {
            this.PaymentBatchUpdates = new HashSet<PaymentBatchUpdate>();
            this.PaymentBatchUpdates1 = new HashSet<PaymentBatchUpdate>();
        }
        ...
        public virtual ICollection<PaymentBatchUpdate> PaymentBatchUpdates1 { get; set; }
    }
}
