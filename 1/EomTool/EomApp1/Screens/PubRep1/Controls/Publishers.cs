...
namespace EomApp1.Screens.PubRep1.Controls
{
    public partial class Publishers : UserControl
    {
        ...
        private void PublisherListUserControl_Load(object sender, EventArgs e)
        {
            ...
            netTermTypeBindingSource.PositionChanged += (se, ev) => SetPublisherFilter();
            ...
            currencyBindingSource.PositionChanged += (se, ev) => SetPublisherFilter();
        ...
        private void InitializeComponent()
        {
            ...
            this.affiliatesHavingReportsTableAdapter = new EomApp1.Screens.PubRep1.Data.PublisherReportDataSet1TableAdapters.AffiliatesHavingReportsTableAdapter();
            ...
            this.netTermTypeTableAdapter = new EomApp1.Screens.PubRep1.Data.PublisherReportDataSet1TableAdapters.NetTermTypeTableAdapter();
            this.currencyTableAdapter = new EomApp1.Screens.PubRep1.Data.PublisherReportDataSet1TableAdapters.CurrencyTableAdapter();
