...
SELECT     dbo.AccountingView1.Publisher, dbo.AccountingView1.Advertiser, dbo.AccountingView1.[Campaign Number], dbo.AccountingView1.[Campaign Name], 
                      ...
                      dbo.AccountingView1.[Cost/Unit], dbo.AccountingView1.[Cost/Unit USD], dbo.AccountingView1.Units, sum(Units) over(partition by [Campaign Number]) as [Total Campaign Units],
                      ...
                      dbo.AccountingView1.[Pub Pay Curr], dbo.AccountingView1.[Cost USD] / dbo.Currency.to_usd_multiplier AS [Pub Payout], Units * 100.0 / sum(Units) over(partition by [Campaign Number]) as [Percentage of Traffic Generated],
