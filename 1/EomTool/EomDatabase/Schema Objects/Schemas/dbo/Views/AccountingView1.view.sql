...
AS
SELECT     TOP (100) PERCENT dbo.Affiliate.name2 AS Publisher, dbo.Advertiser.name AS Advertiser, dbo.Advertiser.qb_name AS [Adv QB Name], dbo.Campaign.pid AS [Campaign Number], 
...
GROUP BY dbo.Affiliate.name2, dbo.Advertiser.name, dbo.Advertiser.qb_name, dbo.Campaign.pid, dbo.Campaign.campaign_name, dbo.Currency.name, Currency_1.name, dbo.Item.revenue_per_unit, 
