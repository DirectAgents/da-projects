...
namespace EomAppControls {
    ...
    public partial class DAMain1DataSet : global::System.Data.DataSet {
        ...
        public partial class SettingsDataTable : global::System.Data.TypedTableBase<SettingsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public SettingsRow AddSettingsRow(int SettingId, string SettingName, string SettingValue) {
...
namespace EomAppControls.DAMain1DataSetTableAdapters {
    ...
    public partial class SettingsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Settings] ([SettingId], [SettingName], [SettingValue]) VALUES " +
                "(@SettingId, @SettingName, @SettingValue);\r\nSELECT SettingId, SettingName, Setti" +
                "ngValue FROM Settings WHERE (SettingId = @SettingId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Settings] SET [SettingId] = @SettingId, [SettingName] = @SettingName, [SettingValue] = @SettingValue WHERE (([SettingId] = @Original_SettingId) AND ([SettingName] = @Original_SettingName));
SELECT SettingId, SettingName, SettingValue FROM Settings WHERE (SettingId = @SettingId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EomAppControls.Properties.Settings.Default.DAMain1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SettingId, SettingName, SettingValue FROM dbo.Settings";
        ...
        public virtual int Fill(DAMain1DataSet.SettingsDataTable dataTable) {
        ...
        public virtual DAMain1DataSet.SettingsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DAMain1DataSet.SettingsDataTable dataTable = new DAMain1DataSet.SettingsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DAMain1DataSet.SettingsDataTable dataTable) {
        ...
        public virtual int Insert(int SettingId, string SettingName, string SettingValue) {
            ...
            if ((SettingValue == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(SettingValue));
            }
        ...
        public virtual int Update(int SettingId, string SettingName, string SettingValue, int Original_SettingId, string Original_SettingName) {
            ...
            if ((SettingValue == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(SettingValue));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string SettingName, string SettingValue, int Original_SettingId, string Original_SettingName) {
            return this.Update(Original_SettingId, SettingName, SettingValue, Original_SettingId, Original_SettingName);
        }
    }
